...
categories: MySQL
banner:
  image: https://raw.githubusercontent.com/Juzi-xyhao/Juzi-xyhao.github.io/master/assets/articleCover/2024-07-03-MySQL.png
  opacity: 0.9
tags: MySQL
top: 1
---
...
# 表空间结构
![image.png](/assets/articleSource/2024-07-03-MySQL/img.png)
...
这里只介绍Compact行格式。
![COMPACT.drawio.jpg](/assets/articleSource/2024-07-03-MySQL/img_1.png)

## null值列表
**null值列表都是以16进制数表示的**
null值列表转换为二进制后**每一位代表对应的列**（逆序对应，如下图）
![image.png](/assets/articleSource/2024-07-03-MySQL/img_2.png)
...
```
![image.png](/assets/articleSource/2024-07-03-MySQL/img_3.png)
选取有代表性的第二条记录：
...
![image.png](/assets/articleSource/2024-07-03-MySQL/img_4.png)
**由于逆序对应,**
...
## 为什么是逆序存放？
![image.png](/assets/articleSource/2024-07-03-MySQL/img_5.png)

![img.png](/assets/articleSource/2024-07-03-MySQL/img_9.png)  
...
![image.png](/assets/articleSource/2024-07-03-MySQL/img_8.png)
