...
categories: 分布式系统
banner:
  image: https://raw.githubusercontent.com/Juzi-xyhao/Juzi-xyhao.github.io/master/assets/articleCover/2024-07-01-Redis.png
  opacity: 0.9
tags: 分布式 Redis
top: 1
---
...
![image.png](/assets/articleSource/2024-07-01-Redis/img.png)
...
具体大小可以根据这个式子得到：
![image.png](/assets/articleSource/2024-07-01-Redis/img_1.png)
