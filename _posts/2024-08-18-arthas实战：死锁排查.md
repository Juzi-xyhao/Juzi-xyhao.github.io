...
layout: post
title: Arthas实战-排查死锁
subtitle: 使用Arthas排查死锁
author: xyhao
categories: Java
banner:
  image: https://raw.githubusercontent.com/Juzi-xyhao/Juzi-xyhao.github.io/master/assets/articleCover/2024-08-01-arthas.png
  opacity: 0.9
tags: Java Arthas
top: 1
sidebar: []
...
```
## 二、使用[Arthas](https://so.csdn.net/so/search?q=Arthas&spm=1001.2101.3001.7020)排查问题

1. 启动 Arthas：
`java -jar arthas-boot.jar`

![image.png](/assets/articleSource/2024-08-18-Arthas/img.png)
![image.png](/assets/articleSource/2024-08-18-Arthas/img_1.png)

2. 查看总体使用情况：
`dashboard`![image.png](/assets/articleSource/2024-08-18-Arthas/img_2.png)
可以看到已经有死锁线程了
3. 查看总体线程使用情况：
`thread`![image.png](/assets/articleSource/2024-08-18-Arthas/img_3.png)**BLOCKED**线程数量：2，并且显示了具体的**BLOCKED**线程
4. 定位死锁的位置：
`thread -b`![image.png](/assets/articleSource/2024-08-18-Arthas/img_4.png)
...
1. 查看死锁线程详细信息：
`thread 21`
`thread 22`![image.png](/assets/articleSource/2024-08-18-Arthas/img_5.png)
